...
import { Star, Music, Award, Users, Calendar, Heart, Zap, Target } from "lucide-react"
...
export default function AdvisorPage() {
  const genres = [
    ...
    { name: "Heartbreak EDM", description: "Electronic emotion & cathartic drops" },
    { name: "Storytelling Rap", description: "Narrative flow & authentic voice" },
  ]
  ...
  const specializations = [
    {
      ...
      description: "Transform personal struggles into powerful artistic expression",
    },
    {
      icon: Zap,
...
<p className="text-base sm:text-lg text-gray-300 mb-6 leading-relaxed tracking-wide">
  ...
  and turn your creative blocks into real, powerful art.
          ...
          <Card className="bg-gray-800 border-gray-700 mb-8">
            <CardHeader>
              <CardTitle className="text-white text-center">How I Help Struggling Artists</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-semibold text-white mb-2">From Struggle to Breakthrough</h4>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    My own creative journey began with years of frustration, self-doubt, and artistic blocks. After
                    hitting rock bottom creatively, I developed the breakthrough techniques that not only saved my own
                    artistic career but have since helped hundreds of struggling artists find their voice.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    <br />• Developed breakthrough methodology used by 10+ artists
                  </p>
                </div>
                <div>
  ...
  <br />• Hands-on experience with FL Studio, Serum, Vital, Swar VST  
  <br />• YouTube channel sharing self-made music and creative insights  
  <br />• Focused on real emotion, not trends — music that feels true
</p>
            ...
            <div className="space-y-6">
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">Genres I Help With</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardHeader>
                  <CardTitle className="text-white">Tools & Software I Use</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {tools.map((tool, index) => (
                      <Badge key={index} variant="outline" className="border-gray-600 text-gray-300 hover:bg-gray-700">
                        {tool}
                      </Badge>
                    ))}
                  </div>
          ...
          <Card className="bg-gray-800 border-gray-700 mt-8">
            <CardHeader>
              <CardTitle className="text-white">Breakthrough Success Stories</CardTitle>
              <p className="text-gray-300">
                Real artists who transformed their creative struggles into artistic breakthroughs
              </p>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                {reviews.map((review, index) => (
                  <div key={index} className="bg-gray-700 rounded-lg p-4">
                    ...
                    <p className="text-gray-300 text-sm italic mb-3">"{review.text}"</p>
          ...
          <Card className="mt-8 bg-gradient-to-r from-purple-900/20 to-pink-900/20 border-purple-500/30">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Ready for Your Creative Breakthrough?</h3>
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Don't let creative blocks define your artistic journey. Book a session and discover how to transform
                your struggles into your greatest musical strengths.
              </p>
